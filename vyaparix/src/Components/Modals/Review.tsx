...
const Rating = ({ size, rating }: { size?: string, rating: number }) => {
    ...
    return (
        <>
            ...
            {(size === "small") && (<div className="flex items-center mb-5">
            ...
            {(size === "medium") && (<div className="flex items-center  mb-5">
                <svg
            ...
            {size === "large" && (<div className="flex items-center">
                <svg
            ...
            {/*SIZE MEDIUM AND LARGE NOT IMPLEMENTED* */}
        </>
